...
for _ in range(1):
    ...
    if prior.startswith('ssg'):
        os.system('python bayes_cnn.py -lr 0.1 -N ' + NN + ' -sn ' + sn + ' -v0 ' + v0 + ' -v1 ' + v1 + ' -seed ' + seed + ' -save 1 -prune 0 ' + ' -sd ' + sd + ' -invT ' + invT + ' -gpu ' + gpu + ' > ./output/resnet20_cifar10_sn_' + sn + '_N_' + NN + '_v0_' + v0 + '_v1_' + v1 + '_sd_' + sd + '_invT_' + invT + '_sparse_' + sparse + '_rand_pretrain_' + seed)
